...
type Peer struct {
	...
	Torrents []*torrent.Torrent `protobuf:"bytes,2,rep,name=torrents,proto3" json:"torrents,omitempty"`
}
...
func (x *Peer) GetTorrents() []*torrent.Torrent {
	if x != nil {
		return x.Torrents
	}
	return nil
...
var file_peer_peer_proto_rawDesc = []byte{
	...
	0x6f, 0x1a, 0x15, 0x74, 0x6f, 0x72, 0x72, 0x65, 0x6e, 0x74, 0x2f, 0x74, 0x6f, 0x72, 0x72, 0x65,
	0x6e, 0x74, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x22, 0x46, 0x0a, 0x04, 0x50, 0x65, 0x65, 0x72,
	0x12, 0x18, 0x0a, 0x07, 0x61, 0x64, 0x64, 0x72, 0x65, 0x73, 0x73, 0x18, 0x01, 0x20, 0x01, 0x28,
	0x09, 0x52, 0x07, 0x61, 0x64, 0x64, 0x72, 0x65, 0x73, 0x73, 0x12, 0x24, 0x0a, 0x08, 0x74, 0x6f,
	0x72, 0x72, 0x65, 0x6e, 0x74, 0x73, 0x18, 0x02, 0x20, 0x03, 0x28, 0x0b, 0x32, 0x08, 0x2e, 0x54,
	...
	0x61, 0x77, 0x69, 0x64, 0x64, 0x36, 0x2f, 0x70, 0x32, 0x70, 0x2f, 0x70, 0x65, 0x65, 0x72, 0x62,
...
var file_peer_peer_proto_msgTypes = make([]protoimpl.MessageInfo, 1)
var file_peer_peer_proto_goTypes = []interface{}{
	(*Peer)(nil),            // 0: Peer
	(*torrent.Torrent)(nil), // 1: Torrent
}
var file_peer_peer_proto_depIdxs = []int32{
	1, // 0: Peer.torrents:type_name -> Torrent
