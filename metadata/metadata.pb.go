...
type Metadata struct {
	...
	Pieces    []*piece.PieceInfo `protobuf:"bytes,3,rep,name=pieces,proto3" json:"pieces,omitempty"`
	Files     []*file.File       `protobuf:"bytes,4,rep,name=files,proto3" json:"files,omitempty"`
}
...
func (x *Metadata) GetPieces() []*piece.PieceInfo {
	if x != nil {
		return x.Pieces
	}
	return nil
...
func (x *Metadata) GetFiles() []*file.File {
	if x != nil {
		return x.Files
	}
	return nil
...
var file_metadata_metadata_proto_rawDesc = []byte{
	...
	0x61, 0x74, 0x61, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x1a, 0x11, 0x70, 0x69, 0x65, 0x63, 0x65,
	0x2f, 0x70, 0x69, 0x65, 0x63, 0x65, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x1a, 0x0f, 0x66, 0x69,
	0x6c, 0x65, 0x2f, 0x66, 0x69, 0x6c, 0x65, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x22, 0x7d, 0x0a,
	...
	0x69, 0x65, 0x63, 0x65, 0x73, 0x18, 0x03, 0x20, 0x03, 0x28, 0x0b, 0x32, 0x0a, 0x2e, 0x50, 0x69,
	0x65, 0x63, 0x65, 0x49, 0x6e, 0x66, 0x6f, 0x52, 0x06, 0x70, 0x69, 0x65, 0x63, 0x65, 0x73, 0x12,
	0x1b, 0x0a, 0x05, 0x66, 0x69, 0x6c, 0x65, 0x73, 0x18, 0x04, 0x20, 0x03, 0x28, 0x0b, 0x32, 0x05,
	0x2e, 0x46, 0x69, 0x6c, 0x65, 0x52, 0x05, 0x66, 0x69, 0x6c, 0x65, 0x73, 0x42, 0x21, 0x5a, 0x1f,
	0x67, 0x69, 0x74, 0x68, 0x75, 0x62, 0x2e, 0x63, 0x6f, 0x6d, 0x2f, 0x64, 0x61, 0x77, 0x69, 0x64,
	0x64, 0x36, 0x2f, 0x70, 0x32, 0x70, 0x2f, 0x6d, 0x65, 0x74, 0x61, 0x64, 0x61, 0x74, 0x61, 0x62,
...
var file_metadata_metadata_proto_goTypes = []interface{}{
	...
	(*piece.PieceInfo)(nil), // 1: PieceInfo
	(*file.File)(nil),       // 2: File
}
var file_metadata_metadata_proto_depIdxs = []int32{
	1, // 0: Metadata.pieces:type_name -> PieceInfo
	2, // 1: Metadata.files:type_name -> File
