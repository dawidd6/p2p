...
var file_proto_proto_rawDesc = []byte{
	...
	0x67, 0x65, 0x32, 0x34, 0x0a, 0x07, 0x54, 0x72, 0x61, 0x63, 0x6b, 0x65, 0x72, 0x12, 0x29, 0x0a,
...
var file_proto_proto_depIdxs = []int32{
	0, // 0: Tracker.SayHello:input_type -> HelloRequest
	1, // 1: Tracker.SayHello:output_type -> HelloResponse
...
func (c *trackerClient) SayHello(ctx context.Context, in *HelloRequest, opts ...grpc.CallOption) (*HelloResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/Tracker/SayHello", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (*UnimplementedTrackerServer) SayHello(context.Context, *HelloRequest) (*HelloResponse, error) {
...
func _Tracker_SayHello_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(HelloRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(TrackerServer).SayHello(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/Tracker/SayHello",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(TrackerServer).SayHello(ctx, req.(*HelloRequest))
	}
...
var _Tracker_serviceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		{
			MethodName: "SayHello",
			Handler:    _Tracker_SayHello_Handler,
		},
	},
