...
type Torrent struct {
	...
	TrackerUrls []string `protobuf:"bytes,6,rep,name=tracker_urls,json=trackerUrls,proto3" json:"tracker_urls,omitempty"`
}
...
func (x *Torrent) GetTrackerUrls() []string {
	if x != nil {
		return x.TrackerUrls
	}
	return nil
}
...
var file_pkg_torrent_torrent_proto_rawDesc = []byte{
	...
	0x72, 0x72, 0x65, 0x6e, 0x74, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x22, 0xc5, 0x01, 0x0a, 0x07,
	...
	0x12, 0x21, 0x0a, 0x0c, 0x74, 0x72, 0x61, 0x63, 0x6b, 0x65, 0x72, 0x5f, 0x75, 0x72, 0x6c, 0x73,
	0x18, 0x06, 0x20, 0x03, 0x28, 0x09, 0x52, 0x0b, 0x74, 0x72, 0x61, 0x63, 0x6b, 0x65, 0x72, 0x55,
	0x72, 0x6c, 0x73, 0x42, 0x24, 0x5a, 0x22, 0x67, 0x69, 0x74, 0x68, 0x75, 0x62, 0x2e, 0x63, 0x6f,
