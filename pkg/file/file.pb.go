...
import (
	piece "github.com/dawidd6/p2p/pkg/piece"
...
type File struct {
	...
	Pieces []*piece.Piece `protobuf:"bytes,4,rep,name=pieces,proto3" json:"pieces,omitempty"`
}
...
func (x *File) GetPieces() []*piece.Piece {
	if x != nil {
		return x.Pieces
	}
	return nil
...
var file_pkg_file_file_proto_rawDesc = []byte{
	...
	0x70, 0x72, 0x6f, 0x74, 0x6f, 0x1a, 0x15, 0x70, 0x6b, 0x67, 0x2f, 0x70, 0x69, 0x65, 0x63, 0x65,
	0x2f, 0x70, 0x69, 0x65, 0x63, 0x65, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x22, 0x66, 0x0a, 0x04,
	0x46, 0x69, 0x6c, 0x65, 0x12, 0x12, 0x0a, 0x04, 0x6e, 0x61, 0x6d, 0x65, 0x18, 0x01, 0x20, 0x01,
	0x28, 0x09, 0x52, 0x04, 0x6e, 0x61, 0x6d, 0x65, 0x12, 0x16, 0x0a, 0x06, 0x73, 0x68, 0x61, 0x32,
	...
	0x73, 0x69, 0x7a, 0x65, 0x12, 0x1e, 0x0a, 0x06, 0x70, 0x69, 0x65, 0x63, 0x65, 0x73, 0x18, 0x04,
	0x20, 0x03, 0x28, 0x0b, 0x32, 0x06, 0x2e, 0x50, 0x69, 0x65, 0x63, 0x65, 0x52, 0x06, 0x70, 0x69,
	0x65, 0x63, 0x65, 0x73, 0x42, 0x21, 0x5a, 0x1f, 0x67, 0x69, 0x74, 0x68, 0x75, 0x62, 0x2e, 0x63,
	0x6f, 0x6d, 0x2f, 0x64, 0x61, 0x77, 0x69, 0x64, 0x64, 0x36, 0x2f, 0x70, 0x32, 0x70, 0x2f, 0x70,
	0x6b, 0x67, 0x2f, 0x66, 0x69, 0x6c, 0x65, 0x62, 0x06, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x33,
}
...
var file_pkg_file_file_proto_msgTypes = make([]protoimpl.MessageInfo, 1)
var file_pkg_file_file_proto_goTypes = []interface{}{
	(*File)(nil),        // 0: File
	(*piece.Piece)(nil), // 1: Piece
}
var file_pkg_file_file_proto_depIdxs = []int32{
	1, // 0: File.pieces:type_name -> Piece
